# Generated by Django 4.2.10 on 2024-04-02 14:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='customers', to='api.address')),
            ],
            options={
                'db_table': 'customer',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField()),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='staff', to='api.address')),
            ],
            options={
                'db_table': 'staff',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField()),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='stores', to='api.address')),
                ('manager_staff', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='manages', to='api.staff')),
            ],
            options={
                'db_table': 'store',
                'managed': True,
